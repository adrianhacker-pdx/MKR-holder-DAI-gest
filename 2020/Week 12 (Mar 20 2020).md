...
* **We don't know what we don't know** current activites are focused on system health and stability following a very serious black swan event.  It is important that a full undertanding of system parameters are realized before more changes are made.  Keeping cause and effect on easy audit trails is critical now more than ever as learning comes from a never before imagined scenario.

* **Eye on the Prize**  Don't let the cyle of urgency and apathy invade as crypto market prices stablize and the black swan grows more distant.  There is important governance and risk discussion and decision making that has been precipitated from recent events that needs to be seen through.
...
Discussion around adding another stable coin to the collateral portifolio is hot.  There are those that are in the thought camp that diversification of stable coin collateral can minimize risk.  There are those that are in the thought camp that the current stable coin addition has a specific use case which will disappear when the system debt is corrected.  USDC, while not the most savory option for a defi platform, is doing well with Dai peg arbitrage and providing liquidity for auction keepers to bid.  To get details or weigh in with your opinion: [To the Forums Jeeves](https://forum.makerdao.com/)

# Public Relations

Discussion and questions have come up regarding protocols for unifying and diseminating information from the community as "one voice."  A mechanism for the DAO to speak authoritatively and officially is the protocol to be defined.  Defining this is no small order.  [Look for forum discussion](https://forum.makerdao.com) and further discussion on calls.

# Emergency Shutdown Criteria

This is a huge subject.  The community wants to define the threshold events that should trigger an emergency shutdown.  Refelction on this past black swan event is a perfect starting point.  Should emergency shutdowns be triggered for purely technical malfunctions?  Should they be a scircuit breaker for monetary loss?  Who are the key stake holders in determining the loss threshold?  What are the itmeized steps to be taken to perform an emergency shutdown?  What is the procedure for a system redeployment following emergency shutdown?  Many questions to debate with few answers as of yet. [Emergency Shutdown Forum Thread](https://forum.makerdao.com/t/what-about-emergency-shutdown-why-have-we-ignored-this-mechanism/1702)
...
Here is a guide from MakerDAO about becoming involved in Governance.  The meeting is held every Thursday, 17:00 UTC.  During the post-mortem and corrective action phase of the recent crypto market prices and resulting fiasco there has been a daily call.  This is expected to drop to two calls over the next week.  Please check the [forums](https://forum.makerdao.com/) for information related to ad-hoc governance and risk calls that may be happening.
